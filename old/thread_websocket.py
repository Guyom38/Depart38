...
class webSocket(): 
    async def tache1_socket():   
        ...
        while VAR.boucle:
            print("[WEBSOCKET]     + Initialisation Tache Socket :")  
            try:
                async with websockets.connect(VAR.urlWss) as websocket: # ...
                    print("[WEBSOCKET]         + boucle thread websocket")
                    VAR.web_socket = True
                ...
                print("[WEBSOCKET]Erreur de connexion. Tentative de reconnexion dans 5 secondes...")
                await asyncio.sleep(5)
            except asyncio.CancelledError:
                print("[WEBSOCKET]Tâche annulée. Nettoyage et fermeture.")
                return
